...
function testchart(epw){
    params = {};
    var value = [];
    var rawData = d3.json("https://raw.githubusercontent.com/JINGYUAN1011/Thermal-tool/main/8760h_data.json");
    var rawData_1 = Array.from(rawData);
    var keys = Object.keys(rawData_1);
    console.log(rawData_1); 
    // value  = rawData_1.map(function(d){return d.Delt_MRT});
    // value = epw.dryBulbTemperature()
    var data = epwData(epw, value); //encoding most of the object construction here  
